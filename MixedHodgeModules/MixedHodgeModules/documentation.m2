...
doc ///
  ...
  Acknowledgement
    We thank Guillem Blanco, Bradley Dirks, Timothy Duff, and Ruijie Yang for helpful conversations. Work on this package began as part of the {\it Macaulay2 Workshop and Mini-School} held at University of Minnesota - Twin Cities,
...
doc ///
  ...
  Outputs
    C: Complex
     a free complex quasi-isomorphic to $\operatorname{Gr}^F_p(\operatorname{DR}(H^1_f(S)))$
  Description
    Text
